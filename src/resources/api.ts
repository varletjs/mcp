...
export async function registerApiResources(server: McpServer) {
    ...
    async () => {
      const components = {
        basic: [
          ...
          {
            name: 'Image',
            description: 'Image component with lazy loading support',
            category: 'basic',
          },
          {
            name: 'Cell',
            description: 'Cell component for list items',
            category: 'basic',
          },
          {
            name: 'Card',
        ...
        form: [
          ...
          {
            name: 'Switch',
            description: 'Switch component for boolean toggle',
            category: 'form',
          },
          {
            name: 'Slider',
            description: 'Slider component for range input',
            category: 'form',
          },
          {
            name: 'Rate',
            description: 'Rate component for rating input',
            category: 'form',
          },
          {
            name: 'Form',
        ...
        feedback: [
          ...
          {
            name: 'Popup',
            description: 'Popup component for overlay content',
            category: 'feedback',
          },
          {
            name: 'Loading',
            description: 'Loading component for async operations',
            category: 'feedback',
          },
          {
            name: 'Snackbar',
            description: 'Snackbar component for notifications',
            category: 'feedback',
          },
          {
            name: 'Tooltip',
          ...
          {
            name: 'Progress',
            description: 'Progress component for showing progress',
            category: 'feedback',
          },
        ],
        navigation: [
          {
            name: 'Tab',
            description: 'Tab component for navigation',
            category: 'navigation',
          },
          {
            name: 'Menu',
            description: 'Menu component for navigation options',
            category: 'navigation',
          },
          {
            name: 'Pagination',
          ...
          {
            name: 'Step',
            description: 'Step component for step-by-step processes',
            category: 'navigation',
          },
        ],
        layout: [
          {
            name: 'List',
            description: 'List component for displaying data',
            category: 'layout',
          },
          {
            name: 'Table',
          ...
          {
            name: 'Divider',
            description: 'Divider component for content separation',
            category: 'layout',
          },
          {
            name: 'Space',
            description: 'Space component for layout spacing',
            category: 'layout',
          },
          {
            name: 'Sticky',
            description: 'Sticky component for fixed positioning',
            category: 'layout',
          },
        ],
        advanced: [
          {
            name: 'Picker',
            description: 'Picker component for option selection',
            category: 'advanced',
          },
          {
            name: 'DatePicker',
            description: 'DatePicker component for date selection',
            category: 'advanced',
          },
          {
            name: 'TimePicker',
            description: 'TimePicker component for time selection',
            category: 'advanced',
          },
          {
            name: 'Uploader',
            description: 'Uploader component for file uploads',
            category: 'advanced',
          },
          {
            name: 'ImagePreview',
            description: 'ImagePreview component for image viewing',
            category: 'advanced',
          },
          {
            name: 'PullRefresh',
            description: 'PullRefresh component for refresh functionality',
            category: 'advanced',
          },
        ],
      };
  ...
  server.resource(
    ...
    'varlet://api/directives',
    {
      description: 'List of all Varlet UI directives',
      mimeType: 'application/json',
    },
    async () => {
      const directives = [
        ...
        },
        {
          ...
          usage:
            'v-lazy="imageUrl" or v-lazy="{ src: imageUrl, loading: loadingUrl }"',
        },
      ];
  ...
  server.resource(
    ...
    'varlet://api/utilities',
    {
      description: 'List of all Varlet UI utilities and services',
      mimeType: 'application/json',
    },
    async () => {
      const utilities = {
        theming: [
          {
            name: 'StyleProvider',
            description: 'Provides custom theme variables',
          },
        ...
        services: [
          ...
          {
            name: 'ImagePreview',
            description: 'Programmatic image preview service',
          },
          {
            name: 'ActionSheet',
            description: 'Programmatic action sheet service',
          },
        ],
        context: [
  ...
  server.resource(
    ...
    'varlet://examples/quick-start',
    {
      description: 'Quick start example for Varlet UI',
...
`;
      ...
      return {
        contents: [
          {
            uri: 'varlet://examples/quick-start.md',
            text: quickStart,
          },
        ],
      };
